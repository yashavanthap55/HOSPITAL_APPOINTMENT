...
const DoctorsList = () => {
 ...
 const appointmentClicked=(param)=>{
  navigate(`/appointment/${param}`);
 }
  const applyFilter = () => {
    if (speciality) {
            ...
            filterDoc.map((item, index) => (
              <div className='p1' key={index} >
                ...
                <div className='p2'>
                  ...
                  <div className="p4" style={{display:'flex',justifyContent:'space-around'}}>
                    <div className="r">
                    <p style={{ fontSize: '1.3vw', fontWeight: '700', color: '#50C878' }}>{item.name}</p>
                    <p style={{ color: '#17B169' }}>{item.speciality}</p>
                    </div>
                  <div className="l">
                    <p style={{color:'var(--background--)'}} onClick={() => appointmentClicked(item._id)}>Book</p>
                  </div>
                  </div>
                </div>
              </div>
